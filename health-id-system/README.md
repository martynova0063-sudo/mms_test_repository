...
HEALTH_ID = w_body * h_body + w_mental * h_mental + w_social * h_social
 
**Веса исследовательской версии:**
Компонент Обозначение Вес
🫀 Физическое здоровье h_body 0,60
🧠 Психическое здоровье h_mental 0,25
🤝 Социальное здоровье h_social 0,15

***Каждый компонент (h_x) рассчитывается как функция от нормированных признаков и сравнения с персональным коридором.***

[
\text{HEALTH_ID} = w_{\text{body}} \cdot h_{\text{body}} + w_{\text{mental}} \cdot h_{\text{mental}} + w_{\text{social}} \cdot h_{\text{social}}
]

где веса исследовательской версии:
